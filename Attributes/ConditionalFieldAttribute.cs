...
namespace ColdHours.Attributes
{
	/// <summary>
...
namespace ColdHours.Attributes
{
	...
	public static class ConditionalFieldUtility
	{
		...
		public static bool PropertyIsVisible(SerializedProperty property, bool inverse, string[] compareAgainst)
		{
			...
			string asString = SerializedPropertyToString(property).ToUpper();
		...
		#region Serialized Property Utils
		/// <summary>
		/// Get string representation of serialized property
		/// </summary>
		public static string SerializedPropertyToString(SerializedProperty property) {
